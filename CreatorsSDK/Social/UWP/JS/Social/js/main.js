...
var m_xblContext = null;
var m_log = null;
var m_user = Microsoft.Xbox.Services.System.XboxLiveUser();

function init() {
    m_log = document.getElementById("log");
        ...
        m_user.signInAsync(null)
            .then(function (e) {
                if (e.status == Microsoft.Xbox.Services.System.SignInStatus.success) {
                    ...
                    m_xblContext = new Microsoft.Xbox.Services.XboxLiveContext(m_user);
                }
                else if (e.status == Microsoft.Xbox.Services.System.SignInStatus.userCancel) {
                    document.getElementById("signIn").innerHTML = "User cancel";
                }
            }, function (err) {
                document.getElementById("signIn").innerHTML = "Signin Failed. Exception details: " + err;
            });
    } catch (err) {
        document.getElementById("signIn").innerHTML = "Signin Failed. Exception details: " + err;
    }
