...
namespace
{
    const wchar_t StatsNameEnemyDefeats[] = L"EnemyDefeats";
    const wchar_t LeaderboardIdEnemyDefeats[] = L"LBEnemyDefeatsDescending";
    ...
    m_frame(0)
{
    ...
    m_liveInfoHUD = std::make_unique<ATG::LiveInfoHUD>(L"Leaderboard Sample");
...
void Sample::Initialize(IUnknown* window)
{
    ...
    (void)EventRegisterXDKS_0301D082();
